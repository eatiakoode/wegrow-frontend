    ...
    <div className="media d-flex justify-content-between align-items-center">
      <div className="d-flex align-items-center">
        <Image
          ...
          alt="image"
        />
        <h5 className="mt-0 mb0">{property?.sellername}</h5>
      </div>
      <div className="media-body">
        <div className="fp_pdate float-end d-flex gap-2 align-items-center">
              <a href={`tel:${property?.sellerphone}`} className="me-2 circle-shape text-dark">
                {/* <i className="fa fa-phone"></i> */}
                <span className="flaticon-telephone"></span>
              </a>
              <a href={`mailto:${property?.selleremail}`} className="circle-shape text-dark">
